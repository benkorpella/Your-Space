...
const controllers = {
    'mongo': require('../controllers/db.posts'),
...
router.get('/add', (req, res) => {
    ...
    controllers.mongo.addPost('Man saves aligator with toothbrush', ['squid', 'aligator', 'idk'], 'benkorpella', body)
});

router.get('/update', (req, res) => {
    res.send('<h1>updated</h1>')
    controllers.mongo.updatePost('606e773044424897ff1c8d68', {tags: ['h']})
});

router.get('/get', (req, res) => {
    res.send('<h1>got</h1>')
    controllers.mongo.getPost('606e773044424897ff1c8d68')
});

router.get('/delete', (req, res) => {
    res.send('<h1>deleted</h1>')
    controllers.mongo.deletePost('606e773044424897ff1c8d68')
});
